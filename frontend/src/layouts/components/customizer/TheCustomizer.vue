        ...
        <VuePerfectScrollbar class="scroll-area--customizer pt-4 pb-6" :settings="settings" :key="$vs.rtl">
          ...
          <div class="px-6">
            ...
            <div class="mt-4">
              ...
              <div>
                <vs-radio v-model="layoutType" vs-value="vertical" class="mr-4" vs-name="layout-type-vertical">纵向</vs-radio>
                <vs-radio v-model="layoutType" vs-value="horizontal" class="mr-4" vs-name="layout-type-horizontal">横向</vs-radio>
              </div>
            </div>
            ...
            <!-- ROUTER ANIMATION -->
            <div class="mt-4">
              <h5 class="mb-2">页面切换动画 {{ routerTransitionLocal }}</h5>
